...
public class ModKeystrokes extends ModDraggable {
	...
	public static enum KeystrokesMode {
		...
		WASD_SNEAK(Key.W, Key.A, Key.S, Key.D, Key.LMB, Key.RMB, new Key("§m-----", Minecraft.getMinecraft().gameSettings.keyBindSneak, 1, 41, 58, 18, false)),
		WASD_SNEAK_MOUSE(Key.W, Key.A, Key.S, Key.LMB, Key.RMB, Key.D, new Key("§m-----", Minecraft.getMinecraft().gameSettings.keyBindSneak, 1, 61, 58, 18, false));
	...
	private ScreenPosition pos = ScreenPosition.fromRelativePosition(0.4, -0.3);
