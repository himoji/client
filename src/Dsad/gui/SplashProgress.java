...
public class SplashProgress {
	...
	public static void drawSplash(TextureManager tm) {
		...
		if(splash == null) {
			splash = new ResourceLocation("Dsad/splash.png");
		}
	...
	private static void drawProgress() {
		...
		if(ufr == null) {
			ufr = UnicodeFontRenderer.getFontOnPC("Arial", 20); //u can change arial to anything else 
		}
		...
		Gui.drawRect(0, sr.getScaledHeight() - 2, (int)calc, sr.getScaledHeight(), new Color(245, 0, 0).getRGB());
